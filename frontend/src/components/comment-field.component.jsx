...
const CommentField = ({ action, index = undefined, replyingTo= undefined, setReplying}) => {
    ...
    let { blog, blog: {_id, author: {_id : blog_author}, activity, activity:{total_comments, total_parent_comments}, comments, comments: {results: commentsArr}}, setBlog, setTotalParentCommentsLoaded} = useContext(BlogContext)
    ...
    const handleComment = (e) => {
        ...
        if(!access_token){
            return toast.error("Please sign in to add a comment")
        }
        ...
        .then(({data}) => {
            ...
            let message = !replyingTo ? "Comment Posted" : "Reply Posted"
