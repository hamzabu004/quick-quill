...
const Notifications = () => {
    ...
    let filters = ['all', 'likes', 'comments', 'replies'];
    ...
    const fetchNotifications = ({page, deletedDocCount=0}) => {
        ...
        let changedFilter = changeFilters(filter)
        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/get-notifications", {page, filter: changedFilter, deletedDocCount}, {
            headers : {
